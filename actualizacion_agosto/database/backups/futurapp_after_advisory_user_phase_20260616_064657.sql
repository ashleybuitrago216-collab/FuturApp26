...
CREATE TABLE `asesorias` (
  ...
  `id_usuario_asesor` int(11) DEFAULT NULL,
  ...
  `telefono_alterno` varchar(15) DEFAULT NULL,
  `id_tipo_servicio` int(11) DEFAULT NULL,
  `descripcion_servicio_final` varchar(1000) DEFAULT NULL,
  ...
  KEY `idx_asesorias_usuario_solicitante` (`id_usuario_solicitante`),
  KEY `idx_asesorias_usuario_asesor` (`id_usuario_asesor`),
  KEY `idx_asesorias_tipo_servicio` (`id_tipo_servicio`),
  ...
  CONSTRAINT `fk_asesorias_tipo_servicio` FOREIGN KEY (`id_tipo_servicio`) REFERENCES `tipos_servicio` (`id_tipo_servicio`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_asesorias_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `fk_asesorias_usuario_asesor` FOREIGN KEY (`id_usuario_asesor`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_asesorias_usuario_solicitante` FOREIGN KEY (`id_usuario_solicitante`) REFERENCES `usuarios` (`id_usuario`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `asesorias` VALUES (1,NULL,25,21,'2026-07-01','09:30:00','Programada','PRUEBA_ASESORIA_FASE1_TEST principal','Asesoria de prueba asignada al asesor demo.',NULL,NULL,NULL,NULL,NULL,'2026-06-16 03:47:27','2026-06-16 06:32:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,NULL,25,24,'2026-07-02','11:00:00','Programada','PRUEBA_ASESORIA_FASE1_TEST asesor b 1781581876995','Asesoria ajena para validar 403.',NULL,NULL,NULL,NULL,NULL,'2026-06-16 03:51:16','2026-06-16 06:32:30',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,29,NULL,'2026-06-17','19:30:00','Pendiente','Solicitud de asesoria','PRUEBA_ASESORIA_USUARIO AU02: el computador se apaga despues de algunos minutos y requiere orientacion inicial.','Computador','3001234567','3019876543',NULL,NULL,'2026-06-16 11:44:48','2026-06-16 11:44:48',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,29,NULL,'2026-06-17','19:30:00','Pendiente','Solicitud de asesoria','PRUEBA_ASESORIA_USUARIO AU03: el computador se apaga despues de algunos minutos y requiere orientacion inicial.','Computador','3001234567',NULL,NULL,NULL,'2026-06-16 11:44:48','2026-06-16 11:44:48',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,NULL,30,NULL,'2026-06-17','19:30:00','Pendiente','Solicitud de asesoria','PRUEBA_ASESORIA_USUARIO AU11: el computador se apaga despues de algunos minutos y requiere orientacion inicial.','Computador','3001234567','3019876543',NULL,NULL,'2026-06-16 11:44:48','2026-06-16 11:44:48',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `roles` VALUES (1,'Administrador'),(6,'Asesor'),(2,'Tecnico'),(3,'Usuario');
...
-- Dump completed on 2026-06-16  6:46:57
