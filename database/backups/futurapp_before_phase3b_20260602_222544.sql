...
INSERT INTO `citas` VALUES (1,1,1,NULL,'2025-11-25','10:00:00',1,2),(2,3,1,NULL,'2025-11-26','14:30:00',0,2),(3,2,3,NULL,'2025-11-21','09:00:00',1,4),(4,5,1,NULL,'2025-11-20','16:00:00',1,2),(5,4,5,NULL,'2025-11-28','11:00:00',0,2);
...
INSERT INTO `empleados` VALUES (1,'Sara Gomez','2023-01-10',2000000.00,NULL,NULL),(2,'Juan Diaz','2024-05-15',1500000.00,NULL,NULL),(3,'Laura Tellez','0000-00-00',1980000.00,NULL,NULL);
...
--
-- Table structure for table `legacy_appointments_20260602_215008`
--
...
--
-- Dumping data for table `legacy_appointments_20260602_215008`
--

LOCK TABLES `legacy_appointments_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_appointments_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_appointments_20260602_215008` VALUES (1,3,2,2,'2026-06-03 14:30:00.000','14:30','3200000000','Completada','2026-06-02 20:58:06.040','2026-06-02 21:24:50.170'),(2,3,2,1,NULL,NULL,'3200000000','Pendiente','2026-06-02 20:58:06.049','2026-06-02 21:16:51.210'),(3,6,2,5,NULL,NULL,NULL,'Completada','2026-06-02 22:25:09.488','2026-06-02 22:25:44.341');
/*!40000 ALTER TABLE `legacy_appointments_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_comments_20260602_215008`
--
...
--
-- Dumping data for table `legacy_comments_20260602_215008`
--

LOCK TABLES `legacy_comments_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_comments_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_comments_20260602_215008` VALUES (1,3,'Excelente atencion durante el diagnostico.','Gracias por confiar en FuturApp.','Admin FuturApp','2026-06-02 20:58:06.073','2026-06-02 20:58:06.073');
/*!40000 ALTER TABLE `legacy_comments_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_notifications_20260602_215008`
--
...
--
-- Dumping data for table `legacy_notifications_20260602_215008`
--

LOCK TABLES `legacy_notifications_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_notifications_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_notifications_20260602_215008` VALUES (1,3,'Tu servicio fue registrado correctamente.','servicio',1,'2026-06-02 20:58:06.066','2026-06-02 21:42:22.868'),(2,2,'Tienes una cita programada.','cita',1,'2026-06-02 20:58:06.066','2026-06-02 22:22:06.581'),(3,1,'Nuevo pago registrado en el sistema.','pago',1,'2026-06-02 20:58:06.066','2026-06-02 22:22:06.581'),(4,2,'Tienes una cita programada.','cita',1,'2026-06-02 21:24:50.136','2026-06-02 22:22:06.581'),(5,3,'Notificacion de prueba API MySQL','sistema',1,'2026-06-02 21:42:22.776','2026-06-02 21:42:22.840');
/*!40000 ALTER TABLE `legacy_notifications_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_payments_20260602_215008`
--
...
--
-- Dumping data for table `legacy_payments_20260602_215008`
--

LOCK TABLES `legacy_payments_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_payments_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_payments_20260602_215008` VALUES (1,'TXN-DEMO-PENDING',3,2,2,1,80000.00,20000.00,60000.00,'Nequi','Pagado','SRV-DEMO-001',1,'2026-06-02 21:34:25.719','2026-06-02 21:34:25.719','2026-06-02 20:58:06.056','2026-06-02 21:34:25.721'),(2,'TXN-DEMO-PAID',3,2,2,1,80000.00,20000.00,60000.00,'Nequi','Pagado','SRV-DEMO-002',1,'2026-06-02 16:00:00.000','2026-06-02 16:00:00.000','2026-06-02 20:58:06.056','2026-06-02 20:58:06.056'),(3,'TXN-DEMO-FAILED',3,2,2,1,40000.00,10000.00,30000.00,'DaviPlata','Fallido','SRV-DEMO-003',0,NULL,NULL,'2026-06-02 20:58:06.056','2026-06-02 20:58:06.056');
/*!40000 ALTER TABLE `legacy_payments_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_roles_20260602_215008`
--
...
--
-- Dumping data for table `legacy_roles_20260602_215008`
--

LOCK TABLES `legacy_roles_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_roles_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_roles_20260602_215008` VALUES (1,'admin','Administrador de FuturApp','2026-06-02 20:58:05.957','2026-06-02 20:58:05.957'),(2,'tecnico','Tecnico de servicios','2026-06-02 20:58:05.957','2026-06-02 20:58:05.957'),(3,'usuario','Usuario cliente','2026-06-02 20:58:05.957','2026-06-02 20:58:05.957');
/*!40000 ALTER TABLE `legacy_roles_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_services_20260602_215008`
--
...
--
-- Dumping data for table `legacy_services_20260602_215008`
--

LOCK TABLES `legacy_services_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_services_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_services_20260602_215008` VALUES (1,3,2,'Mantenimiento de Hardware','Mi computador no enciende correctamente',NULL,'Media','Pendiente',NULL,NULL,'2026-06-02 20:58:06.017','2026-06-02 21:16:51.192'),(2,3,2,'Mantenimiento preventivo de computador','Mantenimiento preventivo de computador','2026-06-02 10:00:00.000','Media','Completado',80000.00,'2 horas','2026-06-02 20:58:06.026','2026-06-02 20:58:06.026'),(3,3,NULL,'Soporte tecnico remoto','Servicio cancelado de prueba',NULL,'Baja','Cancelado',NULL,NULL,'2026-06-02 20:58:06.035','2026-06-02 20:58:06.035'),(4,3,NULL,'Pendiente por clasificar','Servicio creado desde prueba API',NULL,'Pendiente por clasificar','Cancelado',NULL,NULL,'2026-06-02 21:16:50.850','2026-06-02 21:16:50.988'),(5,6,2,'Pendiente por clasificar','mantenimiento de software',NULL,'Pendiente por clasificar','Pendiente',NULL,NULL,'2026-06-02 22:24:13.006','2026-06-02 22:25:09.472');
/*!40000 ALTER TABLE `legacy_services_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_technician_locations_20260602_215008`
--
...
--
-- Dumping data for table `legacy_technician_locations_20260602_215008`
--

LOCK TABLES `legacy_technician_locations_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_technician_locations_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_technician_locations_20260602_215008` VALUES (1,2,4.7110000,-74.0721000,'Disponible','2026-06-02 20:58:06.083','2026-06-02 20:58:06.083','2026-06-02 20:58:06.083');
/*!40000 ALTER TABLE `legacy_technician_locations_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `legacy_users_20260602_215008`
--
...
--
-- Dumping data for table `legacy_users_20260602_215008`
--

LOCK TABLES `legacy_users_20260602_215008` WRITE;
/*!40000 ALTER TABLE `legacy_users_20260602_215008` DISABLE KEYS */;
INSERT INTO `legacy_users_20260602_215008` VALUES (1,1,'Admin','FuturApp','admin@futurapp.com','$2b$10$6oZar07eV8z6WIPUSZl0CuvUQhAEWhqOdkZoeTAtwzhp/D/1aoQea','300165053',NULL,1,'admin','2026-06-02 20:58:05.974','2026-06-02 21:50:53.405','Bogota prueba admin','DOC165053','CC'),(2,2,'Juan Pablo','Martinez','tecnico@futurapp.com','$2b$10$6oZar07eV8z6WIPUSZl0CuvUQhAEWhqOdkZoeTAtwzhp/D/1aoQea','300165053','Hardware',1,'tecnico','2026-06-02 20:58:05.983','2026-06-02 21:50:53.298','Bogota prueba tecnico','DOC165053','CC'),(3,3,'Carlos Andres','Gomez','usuario@futurapp.com','$2b$10$6oZar07eV8z6WIPUSZl0CuvUQhAEWhqOdkZoeTAtwzhp/D/1aoQea','300165052',NULL,1,'usuario','2026-06-02 20:58:05.989','2026-06-02 21:50:53.015','Bogota prueba usuario','DOC165052','CC'),(4,3,'Nuevo','Usuario','nuevo-20260602155834@futurapp.com','$2b$10$/PlGL80t3M2I2d.UD89cbuJU0i/M/PwZNLDWS3ZPNERv/pBdVx7hO',NULL,NULL,1,'usuario','2026-06-02 20:58:35.059','2026-06-02 20:58:35.059',NULL,NULL,NULL),(5,1,'Desarrollo','IA','desarrolloia616@gmail.com','$2b$10$lYgH16iITWzsSRMRM4.iw.f7yaAi5r6Y9LESmCtZYu2XtgOBLZMbO','123456789',NULL,1,'usuario','2026-06-02 22:19:04.591','2026-06-02 22:20:24.224','desarrolloia616@gmail.com',NULL,NULL),(6,3,'cliente','de prueba 1 1','este@11.com','$2b$10$e/Tpq1a8r9bkMIyq3oXKsuycF0NbBoWSW8bHguukREbqoA8q8.6Rq',NULL,NULL,1,'usuario','2026-06-02 22:23:30.301','2026-06-02 22:23:30.301',NULL,NULL,NULL);
/*!40000 ALTER TABLE `legacy_users_20260602_215008` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `medios_pago` VALUES (5,'Criptomonedas'),(3,'Pago en Efectivo'),(4,'PayPal'),(1,'Tarjeta de Crédito'),(2,'Transferencia Bancaria');
...
INSERT INTO `notificaciones` VALUES (1,1,1,'Solicitud Recibida','Su solicitud #1 ha sido recibida con éxito.',1,'2026-04-27 09:32:26'),(2,3,2,'Cita Confirmada','Su cita para la solicitud #2 está confirmada.',0,'2026-04-27 09:32:26'),(3,1,4,'Recordatorio de Cita','Tiene una cita mañana a las 10:00 AM.',0,'2026-04-27 09:32:26'),(4,5,1,'Solicitud Recibida','Su solicitud #4 ha sido recibida.',1,'2026-04-27 09:32:26'),(5,1,3,'Pago Registrado','Hemos recibido el pago de su servicio #2.',1,'2026-04-27 09:32:26');
...
INSERT INTO `usuarios` VALUES (1,1,'Ana','García','ana.garcia@email.com','claveAna','3001234567','Calle 10 # 1-1A',NULL,'2026-04-27 09:32:25',3,1),(2,1,'Luis','Martínez','luis.martinez@email.com','claveLuis','3017654321','Avenida 5 # 2B-2C',3,'2026-04-27 09:32:25',2,1),(3,4,'Pedro','López','pedro.lopez@email.com','clavePedro','3025556677','Carrera 8 # 3-3D',NULL,'2026-04-27 09:32:25',3,1),(4,1,'Sofía','Rodríguez','sofia.rodri@email.com','claveSofia','3034445588','Transversal 12 # 4-4E',1,'2026-04-27 09:32:25',1,1),(5,3,'María','Fernández','maria.f@email.com','claveMaria','3049991122','Diagonal 15 # 5F-6G',NULL,'2026-04-27 09:32:25',3,1),(6,NULL,'Admin','FuturApp','admin@futurapp.com','$2b$10$uxFL6UG43Gkn/Y/452mxIece0RP/Q.UlLqnmQIysI/Bx2e68kIBLK','3000000000',NULL,NULL,'2026-06-03 02:59:26',1,1),(7,NULL,'Tecnico','FuturApp','tecnico@futurapp.com','$2b$10$uxFL6UG43Gkn/Y/452mxIece0RP/Q.UlLqnmQIysI/Bx2e68kIBLK','3100000000',NULL,NULL,'2026-06-03 02:59:26',2,1),(8,NULL,'Usuario','FuturApp','usuario@futurapp.com','$2b$10$uxFL6UG43Gkn/Y/452mxIece0RP/Q.UlLqnmQIysI/Bx2e68kIBLK','3200000000',NULL,NULL,'2026-06-03 02:59:26',3,1);
...
-- Dump completed on 2026-06-02 22:25:45
