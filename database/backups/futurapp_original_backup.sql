...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2026 a las 14:41:51
...
CREATE TABLE `resenas` (
  ...
  `id_usrs` int(11) DEFAULT NULL,
  `id_asesora` int(11) DEFAULT NULL,
  `id_solicitud` int(11) DEFAULT NULL,
...
ALTER TABLE `reportes`
  ...
  ADD KEY `fk_reporte_usuario` (`id_usrs`);
...
ALTER TABLE `resenas`
  ...
  ADD KEY `fk_resena_usuario` (`id_usrs`),
  ADD KEY `fk_resena_asesoria` (`id_asesora`),
  ADD KEY `fk_resena_solicitud` (`id_solicitud`);
...
--
ALTER TABLE `reportes`
  ADD CONSTRAINT `fk_reporte_usuario` FOREIGN KEY (`id_usrs`) REFERENCES `usrs` (`id_usrs`);

--
-- Filtros para la tabla `resenas`
--
ALTER TABLE `resenas`
  ADD CONSTRAINT `fk_resena_asesoria` FOREIGN KEY (`id_asesora`) REFERENCES `asesoria` (`id_asesora`),
  ADD CONSTRAINT `fk_resena_solicitud` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitudes_servicio` (`id_solicitud`),
  ADD CONSTRAINT `fk_resena_usuario` FOREIGN KEY (`id_usrs`) REFERENCES `usrs` (`id_usrs`);
